        ...
        if (user) {
            return (
                <header style={headerCSS}>
                    ...
                    <div style={rightdiv}>
                        <div style={{ borderRadius: "200px", backgroundColor: "white", height: "200px", width: "200px", overflow: "hidden" }}>{/* インラインcss */}
                            <img src={user.photoURL} height="100%" width="100%" alt="userI"/>
                        </div>
