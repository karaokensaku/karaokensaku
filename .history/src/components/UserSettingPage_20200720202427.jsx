...
const MyPage = () => {
    ...
    width: 80 %;
    display: flex;
    border - top: 40px solid rgb(197, 13, 26);
    border - left: 5px solid rgb(197, 13, 26);
    border - right: 5px solid rgb(197, 13, 26);
    border - bottom: 5px solid rgb(197, 13, 26);
    }
                    ...
                    <div style={mainPage}>
                        ...
                        <div style={settingContainer}>
                            <div style={changeUserImg}>
                                ...
                                <div style={{borderRadius: "200px",backgroundColor:"white",height:"200px",width:"200px",overflow:"hidden", margin:"20px"}}>{/* インラインcss */}
